...
mutable struct TransferMatrix <: AbstractTransferMatrix
    ...
    function TransferMatrix(B::Union{AdjointMPSTensor, AdjointLeftIsometricTensor, AdjointRightIsometricTensor}, A::Union{MPSTensor, LeftIsometricTensor, RightIsometricTensor})
        return new(B, A)
    end

...
# Constructor
SimpleIterator(; tol::Union{Float64, Vector{Float64}}=Defaults.tol, maxiter::Int64=Defaults.maxiter)
"""
struct SimpleIterator
    tol::Union{Float64, Vector{Float64}}
    maxiter::Int64

    function SimpleIterator(; tol::Union{Float64, Vector{Float64}}=Defaults.tol, maxiter::Int64=Defaults.maxiter)
        return new(tol, maxiter)
    end
end

const EigenAlgorithm = Union{SimpleIterator, KrylovKit.KrylovAlgorithm}
const GradientAlgorithm = Union{SimpleIterator}

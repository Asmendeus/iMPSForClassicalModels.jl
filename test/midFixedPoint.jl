...
@testset "Real BondEnvironment{3}" begin
    ...
    λ1, C1, _ = midFixedPoint(env, SimpleIteration())
    λ2, C2, _ = midFixedPoint(env, Arnoldi())
    λ1′, C1′, _ = midFixedPoint(env, C1', SimpleIteration())
...
@testset "Real CenterEnvironment{3}" begin
    ...
    λ1, AC1, _ = midFixedPoint(env, SimpleIteration())
    λ2, AC2, _ = midFixedPoint(env, Arnoldi())
    λ1′, AC1′, _ = midFixedPoint(env, AC1', SimpleIteration())
...
@testset "Complex CenterEnvironment{4}" begin
    ...
    λ1, AC1, _ = midFixedPoint(env, X₀, SimpleIteration())
